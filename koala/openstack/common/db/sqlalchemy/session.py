...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/koala/sqlite.db",
        sqlite_db="/var/lib/koala/sqlite.db")
...
from koala.openstack.common.db import exception
from koala.openstack.common.gettextutils import _  # noqa
from koala.openstack.common import log as logging
from koala.openstack.common import timeutils

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='koala.sqlite',
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside koala
            index = file.rfind('koala')
            if index == -1:
                continue
